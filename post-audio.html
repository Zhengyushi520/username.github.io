...
<section class="single-block-wrapper section-padding">
                    ...
                    <div class="col-md-12">
                        <article class="post">
						    ...
						    <div class="post-audio mb-4">
						        <iframe width="100%" height="100%" scrolling="no" frameborder="no" allow="autoplay" src="#" sandbox=""></iframe>
						    </div>
						          ...
						          <p> The Sagoths had begun to take notice of his habit of declaiming throughout entire marches. One of them asked him what he was saying—to whom he was talking. The question gave me an idea, so I answered quickly before Perry could say anything.</p>
						            ...
						            <div class="row">
						                <div class="col-lg-6 col-md-6">
						                    <img src="images/fashion/single-img1.png" alt="post-img1" class="img-fluid mr-4 w-100">
						                </div>
						                <div class="col-lg-6 col-md-6">
	...
	<div class="author-content pl-4">
		<h4 class="mb-3"><a href="#" title="" rel="author" class="text-capitalize">Templates</a></h4>
